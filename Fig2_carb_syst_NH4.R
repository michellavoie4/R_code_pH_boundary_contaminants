...
plot(carb_pH7$xlabel*1E+06-5, carb_pH7$HCO3enrich, type = "l", lty = 1, xlim = c(0, 60), ylim = c(0.9, 1.01), xlab = xlab, ylab = "relative change", main = expression(paste("B : HCO"[3]^"-", " R = 5", mu, "m")))
...
plot(carb_pH7$xlabel*1E+06-5, carb_pH7$CO3enrich, type = "l", lty = 1, xlim = c(0, 60), ylim = c(0.5, 1.01), xlab = xlab, ylab = "relative change", main = expression(paste("C : CO"[3]^"2-", " R = 5", mu, "m")))
...
plot(carb_pH7$xlabel*1E+06-5, carb_pH7$Henrich, type = "l", lty = 1, xlim = c(0, 60), ylim = c(0.9, 1.5), xlab = xlab, ylab = "relative change", main = expression(paste("D : H"^"+", " R = 5", mu, "m")))
...
plot(carb_pH7$xlabel*1E+06-5, carb_pH7$OHenrich, type = "l", lty = 1, xlim = c(0, 60), ylim = c(0.5, 1.01), xlab = xlab, ylab = "relative change", main = expression(paste("E : OH"^"-", " R = 5", mu, "m")))
...
plot(carb_pH7$xlabel*1E+06-30, carb_pH7$CO3enrich, type = "l", lty = 1, xlim = c(0, 100), ylim = c(0.2, 1.1), xlab = xlab, ylab = "relative change", main = expression(paste("H : CO"[3]^"-", " R = 30", mu, "m")))
...
plot(carb_pH7$xlabel*1E+06-30, carb_pH7$Henrich, type = "l", lty = 1, xlim = c(0, 100), ylim = c(1, 4), xlab = xlab, ylab = "relative change", main = expression(paste("I : H"^"+", " R = 30", mu, "m")))
...
plot(carb_pH7$xlabel*1E+06-30, carb_pH7$OHenrich, type = "l", lty = 1, xlim = c(0, 100), ylim = c(0.2, 1.1), xlab = xlab, ylab = "relative change", main = expression(paste("J : OH"^"-", " R = 30" , mu, "m")))
