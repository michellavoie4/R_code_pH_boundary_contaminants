...
# from the cell surface. This computes also relative changes in the boundary layer
...
plot(carb_pH7$xlabel*1E+06-30, carb_pH7$CdOHenrich, type = "l", lty = 1, xlim = c(0, 100), ylim = c(0.3, 1.2), xlab = xlab, ylab = "relative change", main = expression(paste("E : CdOH"^"+", "  R = 30", mu, "m")))
...
plot(carb_pH7$xlabel*1E+06-30, carb_pH7$CdCO3enrich, type = "l", lty = 1, xlim = c(0, 100), ylim = c(0.3, 1.1), xlab = xlab, ylab = "relative change", main = expression(paste("F : CdCO"[3], "  R = 30", mu, "m")))
